...
dependencies {
    ...
    implementation("androidx.compose.runtime:runtime-livedata:1.6.8") // livedata
    ...
    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.8.0-alpha03") // View Model
